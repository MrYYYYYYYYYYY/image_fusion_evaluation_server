...
%        [mssim1, ssim_map1, sigma_XY] = ssim_yang(im1, im2);
        ...
        simXYF=sigma_XF./(sigma_XF+sigma_YF + 1e-10);
...
if (C1 > 0 & C2 > 0)
   ...
   ssim_map(index) = (numerator1(index).*numerator2(index))./(denominator1(index).*denominator2(index) + 1e-10);
   index = (denominator1 ~= 0) & (denominator2 == 0);
   ssim_map(index) = numerator1(index)./denominator1(index) + 1e-10;
end
